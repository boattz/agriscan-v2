...
- **เลือกพืชเตือนได้ทั้งหมด** — dropdown บนการ์ด LINE + `GET /api/alerts/crops`, `GET/POST /api/alerts/crop` (เก็บในตาราง `settings` — restart ไม่หาย, เปลี่ยนพืชล้างสถานะเก่าเริ่มนับใหม่)
